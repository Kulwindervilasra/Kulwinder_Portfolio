...
const Projects = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      category: "blockchain",
      image:
        "https://upload.wikimedia.org/wikipedia/commons/thumb/1/12/5ire-logo2024.png/800px-5ire-logo2024.png?20240217121255",
      logo: "https://upload.wikimedia.org/wikipedia/commons/thumb/1/12/5ire-logo2024.png/800px-5ire-logo2024.png?20240217121255",
      link: "https://5ire.org/",
      description:
        "Created a Substrate-based NPOS blockchain with native token support and applications like IDEs and Wallet extensions. Achieved a reduction in carbon footprint by 15% through eco-friendly infrastructure. Designed and built the validator node architecture and block explorer with real-time network statistics.",
      technologies: [
        "Substrate",
        "Polkadot",
        "Rust",
    ...
    },
    {
      ...
      description:
        "Implemented decentralized apps for the scalable Layer 0 blockchain ecosystem, including Validator/Nominator apps and a decentralized exchange (DEX). Developed cross-chain bridges enabling interoperability with Ethereum, Binance Smart Chain, and Polygon. Optimized smart contracts to reduce gas fees by 22%.",
      technologies: [
        "Layer 0",
        "Blockchain",
        "DApps",
    ...
    },
    {
      title: "Shido Network",
      category: "blockchain",
      image: "https://shido.io/wp-content/uploads/2023/12/Image-2.svg",
      logo: "https://shido.io/wp-content/uploads/2023/12/Image-2.svg",
      link: "https://shido.io/",
      description:
        "Built a Layer 1 Proof-of-Stake blockchain with interoperability across Cosmos, EVM, and WASM frameworks. Designed a modular architecture supporting a diverse ecosystem from DeFi to NFT marketplaces. Implemented a novel consensus mechanism that increased transaction throughput by 300%, handling over 10,000 TPS in stress tests while maintaining security.",
      technologies: [
        "Cosmos SDK",
        "EVM",
        "WASM",
    ...
    },
    {
      ...
      description:
        "Developed a high-performance decentralized wallet enabling secure fund management, token staking, and DeFi interactions on the Fantom blockchain. Implemented advanced security features including multi-signature support, time-locked transactions, and hardware wallet integration. Created an intuitive staking interface that increased user participation in network validation by 45%.",
      technologies: [
        "Fantom",
        "Web3",
        "React",
    ...
    },
    {
      ...
      link: "https://github.com/kulwindervilasra/",
      description:
        "Developed an algorithmic stablecoin protocol maintaining a soft peg to the US dollar through dynamic supply adjustments. Implemented multiple stability mechanisms including collateralized debt positions, algorithmic market operations, and bond issuance. Created a governance system allowing token holders to vote on protocol parameters and treasury allocations, with over $25M in total value locked.",
      technologies: [
        "Stablecoin",
        "DeFi",
        "Solidity",
  ...
  return (
    <div className={styles.container}>
      <Head>
        ...
        <meta
          name="description"
          content="Blockchain and Full-stack projects by Kulwinder Singh, showcasing expertise in Ethereum, Solidity, and Web3"
        />
      ...
      <main className={styles.main}>
        ...
        >
          ...
          <p>
            Showcase of my leading work in blockchain technology and full-stack
            development
          </p>
        </motion.div>
