  ...
  return (
    <header className={styles.header}>
      <div className={styles.headerContent}>
        <Link href="/" className={styles.logo}>KS</Link>
        <nav className={`${styles.nav} ${menuOpen ? styles.active : ''}`}>
          <Link href="/" className={router.pathname === "/" ? styles.active : ""}>Home</Link>
          <Link href="/experience" className={router.pathname === "/experience" ? styles.active : ""}>Experience</Link>
    ...
    <header className={styles.header}>
      <div className={styles.headerContent}>
        ...
        <div className={styles.navRight}>
          ...
          <a
            href="https://www.linkedin.com/in/kulwinder-singh-394384130/"
            target="_blank"
            rel="noopener noreferrer"
            className={styles.socialIcon}
          >
